...
import type { ListBlockTransactionsResponseDataInner } from './ListBlockTransactionsResponseDataInner';
import {
    ListBlockTransactionsResponseDataInnerFromJSON,
    ListBlockTransactionsResponseDataInnerFromJSONTyped,
    ListBlockTransactionsResponseDataInnerToJSON,
} from './ListBlockTransactionsResponseDataInner';
...
/**
 * Check if a given object implements the ListBlockTransactionsResponse interface.
 */
export function instanceOfListBlockTransactionsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListBlockTransactionsResponseFromJSON(json: any): ListBlockTransactionsResponse {
    return ListBlockTransactionsResponseFromJSONTyped(json, false);
}

export function ListBlockTransactionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListBlockTransactionsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListBlockTransactionsResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListBlockTransactionsResponseToJSON(value?: ListBlockTransactionsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListBlockTransactionsResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
