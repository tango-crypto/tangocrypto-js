...
/**
 * Check if a given object implements the ListAddressUtxosResponseDataInnerAssetsInner interface.
 */
export function instanceOfListAddressUtxosResponseDataInnerAssetsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressUtxosResponseDataInnerAssetsInnerFromJSON(json: any): ListAddressUtxosResponseDataInnerAssetsInner {
    return ListAddressUtxosResponseDataInnerAssetsInnerFromJSONTyped(json, false);
}

export function ListAddressUtxosResponseDataInnerAssetsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressUtxosResponseDataInnerAssetsInner {
...
export function ListAddressUtxosResponseDataInnerAssetsInnerToJSON(value?: ListAddressUtxosResponseDataInnerAssetsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
