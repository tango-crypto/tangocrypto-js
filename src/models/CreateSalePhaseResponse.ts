...
import type { CreatePriceTierItem } from './CreatePriceTierItem';
import {
    CreatePriceTierItemFromJSON,
    CreatePriceTierItemFromJSONTyped,
    CreatePriceTierItemToJSON,
} from './CreatePriceTierItem';
...
export interface CreateSalePhaseResponse {
     ...
     * @memberof CreateSalePhaseResponse
     */
    priceTiers?: Array<CreatePriceTierItem>;
    /**
...
/**
 * Check if a given object implements the CreateSalePhaseResponse interface.
 */
export function instanceOfCreateSalePhaseResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateSalePhaseResponseFromJSON(json: any): CreateSalePhaseResponse {
    return CreateSalePhaseResponseFromJSONTyped(json, false);
}

export function CreateSalePhaseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSalePhaseResponse {
    ...
    return {
        ...
        'priceTiers': !exists(json, 'price_tiers') ? undefined : ((json['price_tiers'] as Array<any>).map(CreatePriceTierItemFromJSON)),
        'createdAt': !exists(json, 'created_at') ? undefined : json['created_at'],
        'updatedAt': !exists(json, 'updated_at') ? undefined : json['updated_at'],
    };
}

export function CreateSalePhaseResponseToJSON(value?: CreateSalePhaseResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'price_tiers': value.priceTiers === undefined ? undefined : ((value.priceTiers as Array<any>).map(CreatePriceTierItemToJSON)),
