...
/**
 * Check if a given object implements the NftCollectionPolicy interface.
 */
export function instanceOfNftCollectionPolicy(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionPolicyFromJSON(json: any): NftCollectionPolicy {
    return NftCollectionPolicyFromJSONTyped(json, false);
}

export function NftCollectionPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionPolicy {
...
export function NftCollectionPolicyToJSON(value?: NftCollectionPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
