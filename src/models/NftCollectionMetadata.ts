...
import type { NftCollectionMetadataFilesInner } from './NftCollectionMetadataFilesInner';
import {
    NftCollectionMetadataFilesInnerFromJSON,
    NftCollectionMetadataFilesInnerFromJSONTyped,
    NftCollectionMetadataFilesInnerToJSON,
} from './NftCollectionMetadataFilesInner';
...
/**
 * Check if a given object implements the NftCollectionMetadata interface.
 */
export function instanceOfNftCollectionMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionMetadataFromJSON(json: any): NftCollectionMetadata {
    return NftCollectionMetadataFromJSONTyped(json, false);
}

export function NftCollectionMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionMetadata {
    ...
    return {
        ...
        'files': !exists(json, 'files') ? undefined : ((json['files'] as Array<any>).map(NftCollectionMetadataFilesInnerFromJSON)),
        'attributes': !exists(json, 'attributes') ? undefined : json['attributes'],
        'version': !exists(json, 'version') ? undefined : json['version'],
    };
}

export function NftCollectionMetadataToJSON(value?: NftCollectionMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'files': value.files === undefined ? undefined : ((value.files as Array<any>).map(NftCollectionMetadataFilesInnerToJSON)),
