...
/**
 * Check if a given object implements the CancelNftSaleResponse interface.
 */
export function instanceOfCancelNftSaleResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CancelNftSaleResponseFromJSON(json: any): CancelNftSaleResponse {
    return CancelNftSaleResponseFromJSONTyped(json, false);
}

export function CancelNftSaleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelNftSaleResponse {
    ...
    return {
        ...
        'canceledSaleId': !exists(json, 'canceled_sale_id') ? undefined : json['canceled_sale_id'],
        'canceledAt': !exists(json, 'canceled_at') ? undefined : json['canceled_at'],
    };
}

export function CancelNftSaleResponseToJSON(value?: CancelNftSaleResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'canceled_sale_id': value.canceledSaleId,
