...
/**
 * Check if a given object implements the RetrieveAddressSummaryResponse interface.
 */
export function instanceOfRetrieveAddressSummaryResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveAddressSummaryResponseFromJSON(json: any): RetrieveAddressSummaryResponse {
    return RetrieveAddressSummaryResponseFromJSONTyped(json, false);
}

export function RetrieveAddressSummaryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveAddressSummaryResponse {
...
export function RetrieveAddressSummaryResponseToJSON(value?: RetrieveAddressSummaryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
