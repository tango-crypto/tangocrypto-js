...
/**
 * Check if a given object implements the RetrieveWebhookResponseRulesInner interface.
 */
export function instanceOfRetrieveWebhookResponseRulesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveWebhookResponseRulesInnerFromJSON(json: any): RetrieveWebhookResponseRulesInner {
    return RetrieveWebhookResponseRulesInnerFromJSONTyped(json, false);
}

export function RetrieveWebhookResponseRulesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveWebhookResponseRulesInner {
...
export function RetrieveWebhookResponseRulesInnerToJSON(value?: RetrieveWebhookResponseRulesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
