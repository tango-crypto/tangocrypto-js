...
/**
 * Check if a given object implements the DeleteAffiliateResponse interface.
 */
export function instanceOfDeleteAffiliateResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DeleteAffiliateResponseFromJSON(json: any): DeleteAffiliateResponse {
    return DeleteAffiliateResponseFromJSONTyped(json, false);
}

export function DeleteAffiliateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteAffiliateResponse {
    ...
    return {
        ...
        'deletedAffiliateId': !exists(json, 'deleted_affiliate_id') ? undefined : json['deleted_affiliate_id'],
        'deletedAt': !exists(json, 'deleted_at') ? undefined : json['deleted_at'],
    };
}

export function DeleteAffiliateResponseToJSON(value?: DeleteAffiliateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deleted_affiliate_id': value.deletedAffiliateId,
