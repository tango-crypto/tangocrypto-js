...
/**
 * Check if a given object implements the ListAssetAddressesResponseDataInner interface.
 */
export function instanceOfListAssetAddressesResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAssetAddressesResponseDataInnerFromJSON(json: any): ListAssetAddressesResponseDataInner {
    return ListAssetAddressesResponseDataInnerFromJSONTyped(json, false);
}

export function ListAssetAddressesResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAssetAddressesResponseDataInner {
...
export function ListAssetAddressesResponseDataInnerToJSON(value?: ListAssetAddressesResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
