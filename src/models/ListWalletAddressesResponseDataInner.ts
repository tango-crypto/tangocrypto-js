...
/**
 * Check if a given object implements the ListWalletAddressesResponseDataInner interface.
 */
export function instanceOfListWalletAddressesResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListWalletAddressesResponseDataInnerFromJSON(json: any): ListWalletAddressesResponseDataInner {
    return ListWalletAddressesResponseDataInnerFromJSONTyped(json, false);
}

export function ListWalletAddressesResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWalletAddressesResponseDataInner {
...
export function ListWalletAddressesResponseDataInnerToJSON(value?: ListWalletAddressesResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
