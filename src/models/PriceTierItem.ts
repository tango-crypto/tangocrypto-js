...
import type { PriceTierItemAffiliatesInner } from './PriceTierItemAffiliatesInner';
import {
    PriceTierItemAffiliatesInnerFromJSON,
    PriceTierItemAffiliatesInnerFromJSONTyped,
    PriceTierItemAffiliatesInnerToJSON,
} from './PriceTierItemAffiliatesInner';
...
/**
 * Check if a given object implements the PriceTierItem interface.
 */
export function instanceOfPriceTierItem(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PriceTierItemFromJSON(json: any): PriceTierItem {
    return PriceTierItemFromJSONTyped(json, false);
}

export function PriceTierItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceTierItem {
    ...
    return {
        ...
        'affiliates': !exists(json, 'affiliates') ? undefined : ((json['affiliates'] as Array<any>).map(PriceTierItemAffiliatesInnerFromJSON)),
    };
}

export function PriceTierItemToJSON(value?: PriceTierItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'affiliates': value.affiliates === undefined ? undefined : ((value.affiliates as Array<any>).map(PriceTierItemAffiliatesInnerToJSON)),
    };
}
