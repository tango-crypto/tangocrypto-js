...
/**
 * Check if a given object implements the ListSalePhasesResponseDataInner interface.
 */
export function instanceOfListSalePhasesResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListSalePhasesResponseDataInnerFromJSON(json: any): ListSalePhasesResponseDataInner {
    return ListSalePhasesResponseDataInnerFromJSONTyped(json, false);
}

export function ListSalePhasesResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListSalePhasesResponseDataInner {
...
export function ListSalePhasesResponseDataInnerToJSON(value?: ListSalePhasesResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
