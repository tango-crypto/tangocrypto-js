...
/**
 * Check if a given object implements the CreateWebhookRequestRulesInner interface.
 */
export function instanceOfCreateWebhookRequestRulesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateWebhookRequestRulesInnerFromJSON(json: any): CreateWebhookRequestRulesInner {
    return CreateWebhookRequestRulesInnerFromJSONTyped(json, false);
}

export function CreateWebhookRequestRulesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWebhookRequestRulesInner {
...
export function CreateWebhookRequestRulesInnerToJSON(value?: CreateWebhookRequestRulesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
