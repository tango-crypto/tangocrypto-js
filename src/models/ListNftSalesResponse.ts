...
import type { ListNftSalesResponseDataInner } from './ListNftSalesResponseDataInner';
import {
    ListNftSalesResponseDataInnerFromJSON,
    ListNftSalesResponseDataInnerFromJSONTyped,
    ListNftSalesResponseDataInnerToJSON,
} from './ListNftSalesResponseDataInner';
...
/**
 * Check if a given object implements the ListNftSalesResponse interface.
 */
export function instanceOfListNftSalesResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListNftSalesResponseFromJSON(json: any): ListNftSalesResponse {
    return ListNftSalesResponseFromJSONTyped(json, false);
}

export function ListNftSalesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListNftSalesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListNftSalesResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListNftSalesResponseToJSON(value?: ListNftSalesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListNftSalesResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
