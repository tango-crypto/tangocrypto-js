...
/**
 * Check if a given object implements the UpdateCollectionRequestMetadataFilesInner interface.
 */
export function instanceOfUpdateCollectionRequestMetadataFilesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateCollectionRequestMetadataFilesInnerFromJSON(json: any): UpdateCollectionRequestMetadataFilesInner {
    return UpdateCollectionRequestMetadataFilesInnerFromJSONTyped(json, false);
}

export function UpdateCollectionRequestMetadataFilesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateCollectionRequestMetadataFilesInner {
...
export function UpdateCollectionRequestMetadataFilesInnerToJSON(value?: UpdateCollectionRequestMetadataFilesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
