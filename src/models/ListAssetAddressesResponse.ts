...
import type { ListAssetAddressesResponseDataInner } from './ListAssetAddressesResponseDataInner';
import {
    ListAssetAddressesResponseDataInnerFromJSON,
    ListAssetAddressesResponseDataInnerFromJSONTyped,
    ListAssetAddressesResponseDataInnerToJSON,
} from './ListAssetAddressesResponseDataInner';
...
/**
 * Check if a given object implements the ListAssetAddressesResponse interface.
 */
export function instanceOfListAssetAddressesResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAssetAddressesResponseFromJSON(json: any): ListAssetAddressesResponse {
    return ListAssetAddressesResponseFromJSONTyped(json, false);
}

export function ListAssetAddressesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAssetAddressesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListAssetAddressesResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListAssetAddressesResponseToJSON(value?: ListAssetAddressesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListAssetAddressesResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
