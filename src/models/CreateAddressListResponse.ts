...
/**
 * Check if a given object implements the CreateAddressListResponse interface.
 */
export function instanceOfCreateAddressListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateAddressListResponseFromJSON(json: any): CreateAddressListResponse {
    return CreateAddressListResponseFromJSONTyped(json, false);
}

export function CreateAddressListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAddressListResponse {
...
export function CreateAddressListResponseToJSON(value?: CreateAddressListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
