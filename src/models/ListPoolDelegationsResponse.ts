...
import type { ListPoolDelegationsResponseDataInner } from './ListPoolDelegationsResponseDataInner';
import {
    ListPoolDelegationsResponseDataInnerFromJSON,
    ListPoolDelegationsResponseDataInnerFromJSONTyped,
    ListPoolDelegationsResponseDataInnerToJSON,
} from './ListPoolDelegationsResponseDataInner';
...
/**
 * Check if a given object implements the ListPoolDelegationsResponse interface.
 */
export function instanceOfListPoolDelegationsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListPoolDelegationsResponseFromJSON(json: any): ListPoolDelegationsResponse {
    return ListPoolDelegationsResponseFromJSONTyped(json, false);
}

export function ListPoolDelegationsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPoolDelegationsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListPoolDelegationsResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListPoolDelegationsResponseToJSON(value?: ListPoolDelegationsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListPoolDelegationsResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
