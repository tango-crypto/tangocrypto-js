...
/**
 * Check if a given object implements the ListAdressListResponseDataInner interface.
 */
export function instanceOfListAdressListResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAdressListResponseDataInnerFromJSON(json: any): ListAdressListResponseDataInner {
    return ListAdressListResponseDataInnerFromJSONTyped(json, false);
}

export function ListAdressListResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAdressListResponseDataInner {
...
export function ListAdressListResponseDataInnerToJSON(value?: ListAdressListResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
