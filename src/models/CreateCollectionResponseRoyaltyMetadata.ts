...
import type { CreateCollectionResponseRoyaltyMetadata777 } from './CreateCollectionResponseRoyaltyMetadata777';
import {
    CreateCollectionResponseRoyaltyMetadata777FromJSON,
    CreateCollectionResponseRoyaltyMetadata777FromJSONTyped,
    CreateCollectionResponseRoyaltyMetadata777ToJSON,
} from './CreateCollectionResponseRoyaltyMetadata777';
...
export interface CreateCollectionResponseRoyaltyMetadata {
     ...
     */
    _777?: CreateCollectionResponseRoyaltyMetadata777;
}

/**
 * Check if a given object implements the CreateCollectionResponseRoyaltyMetadata interface.
 */
export function instanceOfCreateCollectionResponseRoyaltyMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateCollectionResponseRoyaltyMetadataFromJSON(json: any): CreateCollectionResponseRoyaltyMetadata {
    return CreateCollectionResponseRoyaltyMetadataFromJSONTyped(json, false);
}

export function CreateCollectionResponseRoyaltyMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCollectionResponseRoyaltyMetadata {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        '_777': !exists(json, '777') ? undefined : CreateCollectionResponseRoyaltyMetadata777FromJSON(json['777']),
    };
}

export function CreateCollectionResponseRoyaltyMetadataToJSON(value?: CreateCollectionResponseRoyaltyMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '777': CreateCollectionResponseRoyaltyMetadata777ToJSON(value._777),
    };
}
