...
import type { CreateCollectionResponseRoyaltyMetadata } from './CreateCollectionResponseRoyaltyMetadata';
import {
    CreateCollectionResponseRoyaltyMetadataFromJSON,
    CreateCollectionResponseRoyaltyMetadataFromJSONTyped,
    CreateCollectionResponseRoyaltyMetadataToJSON,
} from './CreateCollectionResponseRoyaltyMetadata';
...
/**
 * Check if a given object implements the CreateCollectionResponseRoyalty interface.
 */
export function instanceOfCreateCollectionResponseRoyalty(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateCollectionResponseRoyaltyFromJSON(json: any): CreateCollectionResponseRoyalty {
    return CreateCollectionResponseRoyaltyFromJSONTyped(json, false);
}

export function CreateCollectionResponseRoyaltyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCollectionResponseRoyalty {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'metadata': !exists(json, 'metadata') ? undefined : CreateCollectionResponseRoyaltyMetadataFromJSON(json['metadata']),
    };
}

export function CreateCollectionResponseRoyaltyToJSON(value?: CreateCollectionResponseRoyalty | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'metadata': CreateCollectionResponseRoyaltyMetadataToJSON(value.metadata),
    };
}
