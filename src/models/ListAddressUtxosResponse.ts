...
import type { ListAddressUtxosResponseDataInner } from './ListAddressUtxosResponseDataInner';
import {
    ListAddressUtxosResponseDataInnerFromJSON,
    ListAddressUtxosResponseDataInnerFromJSONTyped,
    ListAddressUtxosResponseDataInnerToJSON,
} from './ListAddressUtxosResponseDataInner';
...
/**
 * Check if a given object implements the ListAddressUtxosResponse interface.
 */
export function instanceOfListAddressUtxosResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressUtxosResponseFromJSON(json: any): ListAddressUtxosResponse {
    return ListAddressUtxosResponseFromJSONTyped(json, false);
}

export function ListAddressUtxosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressUtxosResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListAddressUtxosResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListAddressUtxosResponseToJSON(value?: ListAddressUtxosResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListAddressUtxosResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
