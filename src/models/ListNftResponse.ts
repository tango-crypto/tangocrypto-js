...
/**
 * Check if a given object implements the ListNftResponse interface.
 */
export function instanceOfListNftResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListNftResponseFromJSON(json: any): ListNftResponse {
    return ListNftResponseFromJSONTyped(json, false);
}

export function ListNftResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListNftResponse {
...
export function ListNftResponseToJSON(value?: ListNftResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
