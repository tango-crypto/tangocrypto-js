...
/**
 * Check if a given object implements the CheckAddressListRequest interface.
 */
export function instanceOfCheckAddressListRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CheckAddressListRequestFromJSON(json: any): CheckAddressListRequest {
    return CheckAddressListRequestFromJSONTyped(json, false);
}

export function CheckAddressListRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckAddressListRequest {
...
export function CheckAddressListRequestToJSON(value?: CheckAddressListRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
