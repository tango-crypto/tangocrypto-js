...
export function CreateNftRequestTokensInnerImageFromJSON(json: any): CreateNftRequestTokensInnerImage {
    return CreateNftRequestTokensInnerImageFromJSONTyped(json, false);
}

export function CreateNftRequestTokensInnerImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNftRequestTokensInnerImage {
