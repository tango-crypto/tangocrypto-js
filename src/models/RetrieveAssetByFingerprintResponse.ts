...
/**
 * Check if a given object implements the RetrieveAssetByFingerprintResponse interface.
 */
export function instanceOfRetrieveAssetByFingerprintResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveAssetByFingerprintResponseFromJSON(json: any): RetrieveAssetByFingerprintResponse {
    return RetrieveAssetByFingerprintResponseFromJSONTyped(json, false);
}

export function RetrieveAssetByFingerprintResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveAssetByFingerprintResponse {
...
export function RetrieveAssetByFingerprintResponseToJSON(value?: RetrieveAssetByFingerprintResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
