...
import type { ListAddressUtxosResponseDataInnerAssetsInner } from './ListAddressUtxosResponseDataInnerAssetsInner';
import {
    ListAddressUtxosResponseDataInnerAssetsInnerFromJSON,
    ListAddressUtxosResponseDataInnerAssetsInnerFromJSONTyped,
    ListAddressUtxosResponseDataInnerAssetsInnerToJSON,
} from './ListAddressUtxosResponseDataInnerAssetsInner';
...
/**
 * Check if a given object implements the ListAddressUtxosResponseDataInner interface.
 */
export function instanceOfListAddressUtxosResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressUtxosResponseDataInnerFromJSON(json: any): ListAddressUtxosResponseDataInner {
    return ListAddressUtxosResponseDataInnerFromJSONTyped(json, false);
}

export function ListAddressUtxosResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressUtxosResponseDataInner {
    ...
    return {
        ...
        'smartContract': !exists(json, 'smart_contract') ? undefined : json['smart_contract'],
        'assets': !exists(json, 'assets') ? undefined : ((json['assets'] as Array<any>).map(ListAddressUtxosResponseDataInnerAssetsInnerFromJSON)),
    };
}

export function ListAddressUtxosResponseDataInnerToJSON(value?: ListAddressUtxosResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'assets': value.assets === undefined ? undefined : ((value.assets as Array<any>).map(ListAddressUtxosResponseDataInnerAssetsInnerToJSON)),
    };
}
