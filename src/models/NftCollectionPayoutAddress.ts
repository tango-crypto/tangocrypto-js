...
export function NftCollectionPayoutAddressFromJSON(json: any): NftCollectionPayoutAddress {
    return NftCollectionPayoutAddressFromJSONTyped(json, false);
}

export function NftCollectionPayoutAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionPayoutAddress {
