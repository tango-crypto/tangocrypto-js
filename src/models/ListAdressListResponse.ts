...
import type { ListAdressListResponseDataInner } from './ListAdressListResponseDataInner';
import {
    ListAdressListResponseDataInnerFromJSON,
    ListAdressListResponseDataInnerFromJSONTyped,
    ListAdressListResponseDataInnerToJSON,
} from './ListAdressListResponseDataInner';
...
/**
 * Check if a given object implements the ListAdressListResponse interface.
 */
export function instanceOfListAdressListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAdressListResponseFromJSON(json: any): ListAdressListResponse {
    return ListAdressListResponseFromJSONTyped(json, false);
}

export function ListAdressListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAdressListResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListAdressListResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListAdressListResponseToJSON(value?: ListAdressListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListAdressListResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
