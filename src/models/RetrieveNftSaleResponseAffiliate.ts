...
/**
 * Check if a given object implements the RetrieveNftSaleResponseAffiliate interface.
 */
export function instanceOfRetrieveNftSaleResponseAffiliate(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveNftSaleResponseAffiliateFromJSON(json: any): RetrieveNftSaleResponseAffiliate {
    return RetrieveNftSaleResponseAffiliateFromJSONTyped(json, false);
}

export function RetrieveNftSaleResponseAffiliateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveNftSaleResponseAffiliate {
...
export function RetrieveNftSaleResponseAffiliateToJSON(value?: RetrieveNftSaleResponseAffiliate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
