...
/**
 * Check if a given object implements the GetAddressSummary401Response interface.
 */
export function instanceOfGetAddressSummary401Response(value: object): boolean {
    let isInstance = true;
...
export function GetAddressSummary401ResponseFromJSON(json: any): GetAddressSummary401Response {
    return GetAddressSummary401ResponseFromJSONTyped(json, false);
}

export function GetAddressSummary401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAddressSummary401Response {
...
export function GetAddressSummary401ResponseToJSON(value?: GetAddressSummary401Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
