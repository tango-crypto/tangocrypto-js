...
/**
 * Check if a given object implements the ListWebhooksResponseDataInnerRulesInner interface.
 */
export function instanceOfListWebhooksResponseDataInnerRulesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListWebhooksResponseDataInnerRulesInnerFromJSON(json: any): ListWebhooksResponseDataInnerRulesInner {
    return ListWebhooksResponseDataInnerRulesInnerFromJSONTyped(json, false);
}

export function ListWebhooksResponseDataInnerRulesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWebhooksResponseDataInnerRulesInner {
...
export function ListWebhooksResponseDataInnerRulesInnerToJSON(value?: ListWebhooksResponseDataInnerRulesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
