...
import type { ListWalletAddressesResponseDataInner } from './ListWalletAddressesResponseDataInner';
import {
    ListWalletAddressesResponseDataInnerFromJSON,
    ListWalletAddressesResponseDataInnerFromJSONTyped,
    ListWalletAddressesResponseDataInnerToJSON,
} from './ListWalletAddressesResponseDataInner';
...
/**
 * Check if a given object implements the ListWalletAddressesResponse interface.
 */
export function instanceOfListWalletAddressesResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListWalletAddressesResponseFromJSON(json: any): ListWalletAddressesResponse {
    return ListWalletAddressesResponseFromJSONTyped(json, false);
}

export function ListWalletAddressesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWalletAddressesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListWalletAddressesResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListWalletAddressesResponseToJSON(value?: ListWalletAddressesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListWalletAddressesResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
