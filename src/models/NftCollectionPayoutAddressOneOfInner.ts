...
/**
 * Check if a given object implements the NftCollectionPayoutAddressOneOfInner interface.
 */
export function instanceOfNftCollectionPayoutAddressOneOfInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionPayoutAddressOneOfInnerFromJSON(json: any): NftCollectionPayoutAddressOneOfInner {
    return NftCollectionPayoutAddressOneOfInnerFromJSONTyped(json, false);
}

export function NftCollectionPayoutAddressOneOfInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionPayoutAddressOneOfInner {
...
export function NftCollectionPayoutAddressOneOfInnerToJSON(value?: NftCollectionPayoutAddressOneOfInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
