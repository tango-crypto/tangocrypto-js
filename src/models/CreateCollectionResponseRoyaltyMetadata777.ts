...
/**
 * Check if a given object implements the CreateCollectionResponseRoyaltyMetadata777 interface.
 */
export function instanceOfCreateCollectionResponseRoyaltyMetadata777(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateCollectionResponseRoyaltyMetadata777FromJSON(json: any): CreateCollectionResponseRoyaltyMetadata777 {
    return CreateCollectionResponseRoyaltyMetadata777FromJSONTyped(json, false);
}

export function CreateCollectionResponseRoyaltyMetadata777FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCollectionResponseRoyaltyMetadata777 {
...
export function CreateCollectionResponseRoyaltyMetadata777ToJSON(value?: CreateCollectionResponseRoyaltyMetadata777 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
