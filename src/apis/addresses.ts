...
export const AddressesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAddressSummary(appId: string, version: string, address: string, options?: any): ApiPromise<AddressSummary> {
         ...
         * @throws {RequiredError}
         */
        listAddressAssets(appId: string, version: string, address: string, size?: number, cursor?: string, order?: 'asc' | 'desc', options?: any): ApiPromise<PaginateResponse<Asset>> {
         ...
         * @throws {RequiredError}
         */
        listAddressTransactions(appId: string, version: string, address: string, size?: number, cursor?: string, order?: 'asc' | 'desc', options?: any): ApiPromise<PaginateResponse<AddressTransaction>> {
         ...
         * @throws {RequiredError}
         */
        listAddressUtxos(appId: string, version: string, address: string, size?: number, cursor?: string, order?: 'asc' | 'desc', options?: any): ApiPromise<PaginateResponse<Utxo>> {
