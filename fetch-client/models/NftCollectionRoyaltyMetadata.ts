...
import type { NftCollectionRoyaltyMetadata777 } from './NftCollectionRoyaltyMetadata777';
import {
    NftCollectionRoyaltyMetadata777FromJSON,
    NftCollectionRoyaltyMetadata777FromJSONTyped,
    NftCollectionRoyaltyMetadata777ToJSON,
} from './NftCollectionRoyaltyMetadata777';
...
export interface NftCollectionRoyaltyMetadata {
     ...
     */
    _777?: NftCollectionRoyaltyMetadata777;
}

/**
 * Check if a given object implements the NftCollectionRoyaltyMetadata interface.
 */
export function instanceOfNftCollectionRoyaltyMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionRoyaltyMetadataFromJSON(json: any): NftCollectionRoyaltyMetadata {
    return NftCollectionRoyaltyMetadataFromJSONTyped(json, false);
}

export function NftCollectionRoyaltyMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionRoyaltyMetadata {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        '_777': !exists(json, '777') ? undefined : NftCollectionRoyaltyMetadata777FromJSON(json['777']),
    };
}

export function NftCollectionRoyaltyMetadataToJSON(value?: NftCollectionRoyaltyMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '777': NftCollectionRoyaltyMetadata777ToJSON(value._777),
    };
}
