...
import type { RetrieveAddressListResponseDataInner } from './RetrieveAddressListResponseDataInner';
import {
    RetrieveAddressListResponseDataInnerFromJSON,
    RetrieveAddressListResponseDataInnerFromJSONTyped,
    RetrieveAddressListResponseDataInnerToJSON,
} from './RetrieveAddressListResponseDataInner';
...
/**
 * Check if a given object implements the RetrieveAddressListResponse interface.
 */
export function instanceOfRetrieveAddressListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveAddressListResponseFromJSON(json: any): RetrieveAddressListResponse {
    return RetrieveAddressListResponseFromJSONTyped(json, false);
}

export function RetrieveAddressListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveAddressListResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(RetrieveAddressListResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function RetrieveAddressListResponseToJSON(value?: RetrieveAddressListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(RetrieveAddressListResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
