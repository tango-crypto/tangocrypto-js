...
/**
 * Check if a given object implements the PriceTierItemAffiliatesInner interface.
 */
export function instanceOfPriceTierItemAffiliatesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PriceTierItemAffiliatesInnerFromJSON(json: any): PriceTierItemAffiliatesInner {
    return PriceTierItemAffiliatesInnerFromJSONTyped(json, false);
}

export function PriceTierItemAffiliatesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceTierItemAffiliatesInner {
...
export function PriceTierItemAffiliatesInnerToJSON(value?: PriceTierItemAffiliatesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
