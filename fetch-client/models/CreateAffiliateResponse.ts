...
/**
 * Check if a given object implements the CreateAffiliateResponse interface.
 */
export function instanceOfCreateAffiliateResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateAffiliateResponseFromJSON(json: any): CreateAffiliateResponse {
    return CreateAffiliateResponseFromJSONTyped(json, false);
}

export function CreateAffiliateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAffiliateResponse {
...
export function CreateAffiliateResponseToJSON(value?: CreateAffiliateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
