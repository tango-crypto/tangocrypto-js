...
import type { UpdateCollectionRequestMetadataFilesInner } from './UpdateCollectionRequestMetadataFilesInner';
import {
    UpdateCollectionRequestMetadataFilesInnerFromJSON,
    UpdateCollectionRequestMetadataFilesInnerFromJSONTyped,
    UpdateCollectionRequestMetadataFilesInnerToJSON,
} from './UpdateCollectionRequestMetadataFilesInner';
...
/**
 * Check if a given object implements the UpdateCollectionRequestMetadata interface.
 */
export function instanceOfUpdateCollectionRequestMetadata(value: object): boolean {
    let isInstance = true;
...
export function UpdateCollectionRequestMetadataFromJSON(json: any): UpdateCollectionRequestMetadata {
    return UpdateCollectionRequestMetadataFromJSONTyped(json, false);
}

export function UpdateCollectionRequestMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateCollectionRequestMetadata {
    ...
    return {
        ...
        'files': !exists(json, 'files') ? undefined : ((json['files'] as Array<any>).map(UpdateCollectionRequestMetadataFilesInnerFromJSON)),
        'attributes': !exists(json, 'attributes') ? undefined : json['attributes'],
        'version': !exists(json, 'version') ? undefined : json['version'],
    };
}

export function UpdateCollectionRequestMetadataToJSON(value?: UpdateCollectionRequestMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': value.image,
        'files': value.files === undefined ? undefined : ((value.files as Array<any>).map(UpdateCollectionRequestMetadataFilesInnerToJSON)),
