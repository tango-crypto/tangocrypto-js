...
import type { ListSalePhasesResponseDataInner } from './ListSalePhasesResponseDataInner';
import {
    ListSalePhasesResponseDataInnerFromJSON,
    ListSalePhasesResponseDataInnerFromJSONTyped,
    ListSalePhasesResponseDataInnerToJSON,
} from './ListSalePhasesResponseDataInner';
...
/**
 * Check if a given object implements the ListSalePhasesResponse interface.
 */
export function instanceOfListSalePhasesResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListSalePhasesResponseFromJSON(json: any): ListSalePhasesResponse {
    return ListSalePhasesResponseFromJSONTyped(json, false);
}

export function ListSalePhasesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListSalePhasesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListSalePhasesResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListSalePhasesResponseToJSON(value?: ListSalePhasesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListSalePhasesResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
