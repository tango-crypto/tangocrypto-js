...
/**
 * Check if a given object implements the RetrieveTransactionResponseBlock interface.
 */
export function instanceOfRetrieveTransactionResponseBlock(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveTransactionResponseBlockFromJSON(json: any): RetrieveTransactionResponseBlock {
    return RetrieveTransactionResponseBlockFromJSONTyped(json, false);
}

export function RetrieveTransactionResponseBlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveTransactionResponseBlock {
...
export function RetrieveTransactionResponseBlockToJSON(value?: RetrieveTransactionResponseBlock | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
