...
import type { ListAddressAssetsResponseDataInner } from './ListAddressAssetsResponseDataInner';
import {
    ListAddressAssetsResponseDataInnerFromJSON,
    ListAddressAssetsResponseDataInnerFromJSONTyped,
    ListAddressAssetsResponseDataInnerToJSON,
} from './ListAddressAssetsResponseDataInner';
...
/**
 * Check if a given object implements the ListAddressAssetsResponse interface.
 */
export function instanceOfListAddressAssetsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressAssetsResponseFromJSON(json: any): ListAddressAssetsResponse {
    return ListAddressAssetsResponseFromJSONTyped(json, false);
}

export function ListAddressAssetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressAssetsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListAddressAssetsResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListAddressAssetsResponseToJSON(value?: ListAddressAssetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListAddressAssetsResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
