...
/**
 * Check if a given object implements the SubitTansactionResponse interface.
 */
export function instanceOfSubitTansactionResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SubitTansactionResponseFromJSON(json: any): SubitTansactionResponse {
    return SubitTansactionResponseFromJSONTyped(json, false);
}

export function SubitTansactionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubitTansactionResponse {
...
export function SubitTansactionResponseToJSON(value?: SubitTansactionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
