...
/**
 * Check if a given object implements the RetrieveTransactionResponseAssetsInner interface.
 */
export function instanceOfRetrieveTransactionResponseAssetsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveTransactionResponseAssetsInnerFromJSON(json: any): RetrieveTransactionResponseAssetsInner {
    return RetrieveTransactionResponseAssetsInnerFromJSONTyped(json, false);
}

export function RetrieveTransactionResponseAssetsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveTransactionResponseAssetsInner {
...
export function RetrieveTransactionResponseAssetsInnerToJSON(value?: RetrieveTransactionResponseAssetsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
