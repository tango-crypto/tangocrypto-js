...
import type { NftCollectionRoyaltyMetadata } from './NftCollectionRoyaltyMetadata';
import {
    NftCollectionRoyaltyMetadataFromJSON,
    NftCollectionRoyaltyMetadataFromJSONTyped,
    NftCollectionRoyaltyMetadataToJSON,
} from './NftCollectionRoyaltyMetadata';
...
/**
 * Check if a given object implements the NftCollectionRoyalty interface.
 */
export function instanceOfNftCollectionRoyalty(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionRoyaltyFromJSON(json: any): NftCollectionRoyalty {
    return NftCollectionRoyaltyFromJSONTyped(json, false);
}

export function NftCollectionRoyaltyFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionRoyalty {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'metadata': !exists(json, 'metadata') ? undefined : NftCollectionRoyaltyMetadataFromJSON(json['metadata']),
    };
}

export function NftCollectionRoyaltyToJSON(value?: NftCollectionRoyalty | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'metadata': NftCollectionRoyaltyMetadataToJSON(value.metadata),
    };
}
