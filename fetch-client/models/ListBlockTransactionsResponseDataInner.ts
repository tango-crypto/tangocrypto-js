...
/**
 * Check if a given object implements the ListBlockTransactionsResponseDataInner interface.
 */
export function instanceOfListBlockTransactionsResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListBlockTransactionsResponseDataInnerFromJSON(json: any): ListBlockTransactionsResponseDataInner {
    return ListBlockTransactionsResponseDataInnerFromJSONTyped(json, false);
}

export function ListBlockTransactionsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListBlockTransactionsResponseDataInner {
    ...
    return {
        ...
        'validContract': !exists(json, 'valid_contract') ? undefined : json['valid_contract'],
        'scriptSize': !exists(json, 'script_size') ? undefined : json['script_size'],
    };
}

export function ListBlockTransactionsResponseDataInnerToJSON(value?: ListBlockTransactionsResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'valid_contract': value.validContract,
        'script_size': value.scriptSize,
    };
}
