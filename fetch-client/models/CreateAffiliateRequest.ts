...
export interface CreateAffiliateRequest {
     ...
     * @memberof CreateAffiliateRequest
     */
    commissionType: CreateAffiliateRequestCommissionTypeEnum;
}
...
/**
 * Check if a given object implements the CreateAffiliateRequest interface.
 */
export function instanceOfCreateAffiliateRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "address" in value;
    isInstance = isInstance && "commission" in value;
    isInstance = isInstance && "commissionType" in value;

    return isInstance;
}

export function CreateAffiliateRequestFromJSON(json: any): CreateAffiliateRequest {
    return CreateAffiliateRequestFromJSONTyped(json, false);
}

export function CreateAffiliateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAffiliateRequest {
...
export function CreateAffiliateRequestToJSON(value?: CreateAffiliateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
