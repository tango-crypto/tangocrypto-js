...
/**
 * Check if a given object implements the RetrieveNftSaleResponse interface.
 */
export function instanceOfRetrieveNftSaleResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveNftSaleResponseFromJSON(json: any): RetrieveNftSaleResponse {
    return RetrieveNftSaleResponseFromJSONTyped(json, false);
}

export function RetrieveNftSaleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveNftSaleResponse {
...
export function RetrieveNftSaleResponseToJSON(value?: RetrieveNftSaleResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
