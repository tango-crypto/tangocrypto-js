...
/**
 * Check if a given object implements the DeleteSalePhaseResponse interface.
 */
export function instanceOfDeleteSalePhaseResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DeleteSalePhaseResponseFromJSON(json: any): DeleteSalePhaseResponse {
    return DeleteSalePhaseResponseFromJSONTyped(json, false);
}

export function DeleteSalePhaseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteSalePhaseResponse {
...
export function DeleteSalePhaseResponseToJSON(value?: DeleteSalePhaseResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
