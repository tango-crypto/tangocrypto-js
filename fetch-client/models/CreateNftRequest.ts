...
import type { CreateNftRequestTokensInner } from './CreateNftRequestTokensInner';
import {
    CreateNftRequestTokensInnerFromJSON,
    CreateNftRequestTokensInnerFromJSONTyped,
    CreateNftRequestTokensInnerToJSON,
} from './CreateNftRequestTokensInner';
...
export function CreateNftRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNftRequest {
    ...
    return {
        ...
        'tokens': ((json['tokens'] as Array<any>).map(CreateNftRequestTokensInnerFromJSON)),
    };
}
...
export function CreateNftRequestToJSON(value?: CreateNftRequest | null): any {
    ...
    return {
        ...
        'tokens': ((value.tokens as Array<any>).map(CreateNftRequestTokensInnerToJSON)),
    };
}
