...
import type { ListWebhooksResponseDataInner } from './ListWebhooksResponseDataInner';
import {
    ListWebhooksResponseDataInnerFromJSON,
    ListWebhooksResponseDataInnerFromJSONTyped,
    ListWebhooksResponseDataInnerToJSON,
} from './ListWebhooksResponseDataInner';
...
export function ListWebhooksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWebhooksResponse {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListWebhooksResponseDataInnerFromJSON)),
...
export function ListWebhooksResponseToJSON(value?: ListWebhooksResponse | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListWebhooksResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
