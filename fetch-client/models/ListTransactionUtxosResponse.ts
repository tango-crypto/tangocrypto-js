...
import type { ListTransactionUtxosResponseInputsInner } from './ListTransactionUtxosResponseInputsInner';
import {
    ListTransactionUtxosResponseInputsInnerFromJSON,
    ListTransactionUtxosResponseInputsInnerFromJSONTyped,
    ListTransactionUtxosResponseInputsInnerToJSON,
} from './ListTransactionUtxosResponseInputsInner';
import type { ListTransactionUtxosResponseOutputsInner } from './ListTransactionUtxosResponseOutputsInner';
import {
    ListTransactionUtxosResponseOutputsInnerFromJSON,
    ListTransactionUtxosResponseOutputsInnerFromJSONTyped,
    ListTransactionUtxosResponseOutputsInnerToJSON,
} from './ListTransactionUtxosResponseOutputsInner';
...
/**
 * Check if a given object implements the ListTransactionUtxosResponse interface.
 */
export function instanceOfListTransactionUtxosResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListTransactionUtxosResponseFromJSON(json: any): ListTransactionUtxosResponse {
    return ListTransactionUtxosResponseFromJSONTyped(json, false);
}

export function ListTransactionUtxosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTransactionUtxosResponse {
    ...
    return {
        ...
        'inputs': !exists(json, 'inputs') ? undefined : ((json['inputs'] as Array<any>).map(ListTransactionUtxosResponseInputsInnerFromJSON)),
        'outputs': !exists(json, 'outputs') ? undefined : ((json['outputs'] as Array<any>).map(ListTransactionUtxosResponseOutputsInnerFromJSON)),
    };
}

export function ListTransactionUtxosResponseToJSON(value?: ListTransactionUtxosResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'hash': value.hash,
        'inputs': value.inputs === undefined ? undefined : ((value.inputs as Array<any>).map(ListTransactionUtxosResponseInputsInnerToJSON)),
        'outputs': value.outputs === undefined ? undefined : ((value.outputs as Array<any>).map(ListTransactionUtxosResponseOutputsInnerToJSON)),
    };
}
