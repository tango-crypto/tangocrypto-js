...
/**
 * Check if a given object implements the GetAddressSummary400Response interface.
 */
export function instanceOfGetAddressSummary400Response(value: object): boolean {
    let isInstance = true;
...
export function GetAddressSummary400ResponseFromJSON(json: any): GetAddressSummary400Response {
    return GetAddressSummary400ResponseFromJSONTyped(json, false);
}

export function GetAddressSummary400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAddressSummary400Response {
...
export function GetAddressSummary400ResponseToJSON(value?: GetAddressSummary400Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
