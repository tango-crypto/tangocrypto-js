...
/**
 * Check if a given object implements the CreateCollectionRequestMetadataFilesInner interface.
 */
export function instanceOfCreateCollectionRequestMetadataFilesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreateCollectionRequestMetadataFilesInnerFromJSON(json: any): CreateCollectionRequestMetadataFilesInner {
    return CreateCollectionRequestMetadataFilesInnerFromJSONTyped(json, false);
}

export function CreateCollectionRequestMetadataFilesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCollectionRequestMetadataFilesInner {
...
export function CreateCollectionRequestMetadataFilesInnerToJSON(value?: CreateCollectionRequestMetadataFilesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
