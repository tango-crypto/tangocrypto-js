...
/**
 * Check if a given object implements the ListPolicyAssetsResponseDataInner interface.
 */
export function instanceOfListPolicyAssetsResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListPolicyAssetsResponseDataInnerFromJSON(json: any): ListPolicyAssetsResponseDataInner {
    return ListPolicyAssetsResponseDataInnerFromJSONTyped(json, false);
}

export function ListPolicyAssetsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPolicyAssetsResponseDataInner {
...
export function ListPolicyAssetsResponseDataInnerToJSON(value?: ListPolicyAssetsResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
