...
/**
 * Check if a given object implements the GetAddressSummary500Response interface.
 */
export function instanceOfGetAddressSummary500Response(value: object): boolean {
    let isInstance = true;
...
export function GetAddressSummary500ResponseFromJSON(json: any): GetAddressSummary500Response {
    return GetAddressSummary500ResponseFromJSONTyped(json, false);
}

export function GetAddressSummary500ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAddressSummary500Response {
...
export function GetAddressSummary500ResponseToJSON(value?: GetAddressSummary500Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
