...
/**
 * Check if a given object implements the GetAddressSummary404Response interface.
 */
export function instanceOfGetAddressSummary404Response(value: object): boolean {
    let isInstance = true;
...
export function GetAddressSummary404ResponseFromJSON(json: any): GetAddressSummary404Response {
    return GetAddressSummary404ResponseFromJSONTyped(json, false);
}

export function GetAddressSummary404ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAddressSummary404Response {
...
export function GetAddressSummary404ResponseToJSON(value?: GetAddressSummary404Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
