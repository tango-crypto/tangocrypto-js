...
/**
 * Check if a given object implements the CollectionDeleteResponse interface.
 */
export function instanceOfCollectionDeleteResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CollectionDeleteResponseFromJSON(json: any): CollectionDeleteResponse {
    return CollectionDeleteResponseFromJSONTyped(json, false);
}

export function CollectionDeleteResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CollectionDeleteResponse {
    ...
    return {
        ...
        'deletedCollectionId': !exists(json, 'deleted_collection_id') ? undefined : json['deleted_collection_id'],
        'deletedAt': !exists(json, 'deleted_at') ? undefined : json['deleted_at'],
    };
}

export function CollectionDeleteResponseToJSON(value?: CollectionDeleteResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deleted_collection_id': value.deletedCollectionId,
