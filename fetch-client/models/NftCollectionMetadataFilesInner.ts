...
/**
 * Check if a given object implements the NftCollectionMetadataFilesInner interface.
 */
export function instanceOfNftCollectionMetadataFilesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionMetadataFilesInnerFromJSON(json: any): NftCollectionMetadataFilesInner {
    return NftCollectionMetadataFilesInnerFromJSONTyped(json, false);
}

export function NftCollectionMetadataFilesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionMetadataFilesInner {
...
export function NftCollectionMetadataFilesInnerToJSON(value?: NftCollectionMetadataFilesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
