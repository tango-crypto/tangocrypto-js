...
/**
 * Check if a given object implements the PolicyScriptScriptsInner interface.
 */
export function instanceOfPolicyScriptScriptsInner(value: object): boolean {
    let isInstance = true;
...
export function PolicyScriptScriptsInnerFromJSON(json: any): PolicyScriptScriptsInner {
    return PolicyScriptScriptsInnerFromJSONTyped(json, false);
}

export function PolicyScriptScriptsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PolicyScriptScriptsInner {
...
export function PolicyScriptScriptsInnerToJSON(value?: PolicyScriptScriptsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
