...
/**
 * Check if a given object implements the ListAddressAssetsResponseDataInner interface.
 */
export function instanceOfListAddressAssetsResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressAssetsResponseDataInnerFromJSON(json: any): ListAddressAssetsResponseDataInner {
    return ListAddressAssetsResponseDataInnerFromJSONTyped(json, false);
}

export function ListAddressAssetsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressAssetsResponseDataInner {
...
export function ListAddressAssetsResponseDataInnerToJSON(value?: ListAddressAssetsResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
