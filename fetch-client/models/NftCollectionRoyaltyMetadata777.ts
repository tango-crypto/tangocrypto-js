...
/**
 * Check if a given object implements the NftCollectionRoyaltyMetadata777 interface.
 */
export function instanceOfNftCollectionRoyaltyMetadata777(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NftCollectionRoyaltyMetadata777FromJSON(json: any): NftCollectionRoyaltyMetadata777 {
    return NftCollectionRoyaltyMetadata777FromJSONTyped(json, false);
}

export function NftCollectionRoyaltyMetadata777FromJSONTyped(json: any, ignoreDiscriminator: boolean): NftCollectionRoyaltyMetadata777 {
...
export function NftCollectionRoyaltyMetadata777ToJSON(value?: NftCollectionRoyaltyMetadata777 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
