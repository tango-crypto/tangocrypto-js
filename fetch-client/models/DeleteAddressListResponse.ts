...
/**
 * Check if a given object implements the DeleteAddressListResponse interface.
 */
export function instanceOfDeleteAddressListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DeleteAddressListResponseFromJSON(json: any): DeleteAddressListResponse {
    return DeleteAddressListResponseFromJSONTyped(json, false);
}

export function DeleteAddressListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteAddressListResponse {
    ...
    return {
        ...
        'deletedPhaseId': !exists(json, 'deleted_phase_id') ? undefined : json['deleted_phase_id'],
        'deletedAt': !exists(json, 'deleted_at') ? undefined : json['deleted_at'],
    };
}

export function DeleteAddressListResponseToJSON(value?: DeleteAddressListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deleted_phase_id': value.deletedPhaseId,
