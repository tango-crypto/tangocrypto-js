...
/**
 * Check if a given object implements the ListPoolDelegationsResponseDataInner interface.
 */
export function instanceOfListPoolDelegationsResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListPoolDelegationsResponseDataInnerFromJSON(json: any): ListPoolDelegationsResponseDataInner {
    return ListPoolDelegationsResponseDataInnerFromJSONTyped(json, false);
}

export function ListPoolDelegationsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPoolDelegationsResponseDataInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'stakeAddress': !exists(json, 'stake_address') ? undefined : json['stake_address'],
        'availableRewards': !exists(json, 'available_rewards') ? undefined : json['available_rewards'],
        'stake': !exists(json, 'stake') ? undefined : json['stake'],
    };
}

export function ListPoolDelegationsResponseDataInnerToJSON(value?: ListPoolDelegationsResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'stake_address': value.stakeAddress,
        'available_rewards': value.availableRewards,
        'stake': value.stake,
    };
}
