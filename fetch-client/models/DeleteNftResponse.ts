...
/**
 * Check if a given object implements the DeleteNftResponse interface.
 */
export function instanceOfDeleteNftResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DeleteNftResponseFromJSON(json: any): DeleteNftResponse {
    return DeleteNftResponseFromJSONTyped(json, false);
}

export function DeleteNftResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteNftResponse {
    ...
    return {
        ...
        'deletedTokenId': !exists(json, 'deleted_token_id') ? undefined : json['deleted_token_id'],
        'deletedAt': !exists(json, 'deleted_at') ? undefined : json['deleted_at'],
    };
}

export function DeleteNftResponseToJSON(value?: DeleteNftResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deleted_token_id': value.deletedTokenId,
