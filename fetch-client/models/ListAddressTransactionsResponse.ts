...
import type { ListAddressTransactionsResponseDataInner } from './ListAddressTransactionsResponseDataInner';
import {
    ListAddressTransactionsResponseDataInnerFromJSON,
    ListAddressTransactionsResponseDataInnerFromJSONTyped,
    ListAddressTransactionsResponseDataInnerToJSON,
} from './ListAddressTransactionsResponseDataInner';
...
/**
 * Check if a given object implements the ListAddressTransactionsResponse interface.
 */
export function instanceOfListAddressTransactionsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListAddressTransactionsResponseFromJSON(json: any): ListAddressTransactionsResponse {
    return ListAddressTransactionsResponseFromJSONTyped(json, false);
}

export function ListAddressTransactionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressTransactionsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListAddressTransactionsResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListAddressTransactionsResponseToJSON(value?: ListAddressTransactionsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListAddressTransactionsResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
