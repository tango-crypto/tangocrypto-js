...
/**
 * Check if a given object implements the ListTransactionUtxosResponseInputsInner interface.
 */
export function instanceOfListTransactionUtxosResponseInputsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListTransactionUtxosResponseInputsInnerFromJSON(json: any): ListTransactionUtxosResponseInputsInner {
    return ListTransactionUtxosResponseInputsInnerFromJSONTyped(json, false);
}

export function ListTransactionUtxosResponseInputsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTransactionUtxosResponseInputsInner {
...
export function ListTransactionUtxosResponseInputsInnerToJSON(value?: ListTransactionUtxosResponseInputsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
