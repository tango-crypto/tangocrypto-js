...
import type { RetrieveTransactionMetadataResponseDataInner } from './RetrieveTransactionMetadataResponseDataInner';
import {
    RetrieveTransactionMetadataResponseDataInnerFromJSON,
    RetrieveTransactionMetadataResponseDataInnerFromJSONTyped,
    RetrieveTransactionMetadataResponseDataInnerToJSON,
} from './RetrieveTransactionMetadataResponseDataInner';
...
/**
 * Check if a given object implements the RetrieveTransactionMetadataResponse interface.
 */
export function instanceOfRetrieveTransactionMetadataResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveTransactionMetadataResponseFromJSON(json: any): RetrieveTransactionMetadataResponse {
    return RetrieveTransactionMetadataResponseFromJSONTyped(json, false);
}

export function RetrieveTransactionMetadataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveTransactionMetadataResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(RetrieveTransactionMetadataResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function RetrieveTransactionMetadataResponseToJSON(value?: RetrieveTransactionMetadataResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(RetrieveTransactionMetadataResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
