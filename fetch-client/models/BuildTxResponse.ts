...
/**
 * Check if a given object implements the BuildTxResponse interface.
 */
export function instanceOfBuildTxResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BuildTxResponseFromJSON(json: any): BuildTxResponse {
    return BuildTxResponseFromJSONTyped(json, false);
}

export function BuildTxResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuildTxResponse {
...
export function BuildTxResponseToJSON(value?: BuildTxResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
