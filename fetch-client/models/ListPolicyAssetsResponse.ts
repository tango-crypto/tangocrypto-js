...
import type { ListPolicyAssetsResponseDataInner } from './ListPolicyAssetsResponseDataInner';
import {
    ListPolicyAssetsResponseDataInnerFromJSON,
    ListPolicyAssetsResponseDataInnerFromJSONTyped,
    ListPolicyAssetsResponseDataInnerToJSON,
} from './ListPolicyAssetsResponseDataInner';
...
/**
 * Check if a given object implements the ListPolicyAssetsResponse interface.
 */
export function instanceOfListPolicyAssetsResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListPolicyAssetsResponseFromJSON(json: any): ListPolicyAssetsResponse {
    return ListPolicyAssetsResponseFromJSONTyped(json, false);
}

export function ListPolicyAssetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPolicyAssetsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListPolicyAssetsResponseDataInnerFromJSON)),
        'cursor': !exists(json, 'cursor') ? undefined : json['cursor'],
    };
}

export function ListPolicyAssetsResponseToJSON(value?: ListPolicyAssetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListPolicyAssetsResponseDataInnerToJSON)),
        'cursor': value.cursor,
    };
}
