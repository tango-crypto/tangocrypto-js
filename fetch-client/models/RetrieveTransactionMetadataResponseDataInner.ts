...
/**
 * Check if a given object implements the RetrieveTransactionMetadataResponseDataInner interface.
 */
export function instanceOfRetrieveTransactionMetadataResponseDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrieveTransactionMetadataResponseDataInnerFromJSON(json: any): RetrieveTransactionMetadataResponseDataInner {
    return RetrieveTransactionMetadataResponseDataInnerFromJSONTyped(json, false);
}

export function RetrieveTransactionMetadataResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveTransactionMetadataResponseDataInner {
...
export function RetrieveTransactionMetadataResponseDataInnerToJSON(value?: RetrieveTransactionMetadataResponseDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
