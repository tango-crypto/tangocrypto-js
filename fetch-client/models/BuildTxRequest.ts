...
import type { BuildTxRequestInputsInner } from './BuildTxRequestInputsInner';
import {
    BuildTxRequestInputsInnerFromJSON,
    BuildTxRequestInputsInnerFromJSONTyped,
    BuildTxRequestInputsInnerToJSON,
} from './BuildTxRequestInputsInner';
import type { BuildTxRequestMintingScript } from './BuildTxRequestMintingScript';
import {
    BuildTxRequestMintingScriptFromJSON,
    BuildTxRequestMintingScriptFromJSONTyped,
    BuildTxRequestMintingScriptToJSON,
} from './BuildTxRequestMintingScript';
...
export interface BuildTxRequest {
     ...
     * @memberof BuildTxRequest
     */
    mintingScript?: BuildTxRequestMintingScript;
    /**
     * 
     * @type {string}
     * @memberof BuildTxRequest
...
/**
 * Check if a given object implements the BuildTxRequest interface.
 */
export function instanceOfBuildTxRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BuildTxRequestFromJSON(json: any): BuildTxRequest {
    return BuildTxRequestFromJSONTyped(json, false);
}

export function BuildTxRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuildTxRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'inputs': !exists(json, 'inputs') ? undefined : ((json['inputs'] as Array<any>).map(BuildTxRequestInputsInnerFromJSON)),
        'recipients': !exists(json, 'recipients') ? undefined : json['recipients'],
        'mintingScript': !exists(json, 'minting_script') ? undefined : BuildTxRequestMintingScriptFromJSON(json['minting_script']),
        'changeAddress': !exists(json, 'change_address') ? undefined : json['change_address'],
    };
}

export function BuildTxRequestToJSON(value?: BuildTxRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'inputs': value.inputs === undefined ? undefined : ((value.inputs as Array<any>).map(BuildTxRequestInputsInnerToJSON)),
        'recipients': value.recipients,
        'minting_script': BuildTxRequestMintingScriptToJSON(value.mintingScript),
