...
/**
 * Check if a given object implements the GetAddressSummary429Response interface.
 */
export function instanceOfGetAddressSummary429Response(value: object): boolean {
    let isInstance = true;
...
export function GetAddressSummary429ResponseFromJSON(json: any): GetAddressSummary429Response {
    return GetAddressSummary429ResponseFromJSONTyped(json, false);
}

export function GetAddressSummary429ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAddressSummary429Response {
...
export function GetAddressSummary429ResponseToJSON(value?: GetAddressSummary429Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
