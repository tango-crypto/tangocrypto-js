...
/**
 * Check if a given object implements the BuildTxRequestMintingScriptScriptsInner interface.
 */
export function instanceOfBuildTxRequestMintingScriptScriptsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BuildTxRequestMintingScriptScriptsInnerFromJSON(json: any): BuildTxRequestMintingScriptScriptsInner {
    return BuildTxRequestMintingScriptScriptsInnerFromJSONTyped(json, false);
}

export function BuildTxRequestMintingScriptScriptsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuildTxRequestMintingScriptScriptsInner {
...
export function BuildTxRequestMintingScriptScriptsInnerToJSON(value?: BuildTxRequestMintingScriptScriptsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
